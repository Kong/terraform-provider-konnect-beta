...
### Bug fixes
* Fix `kuma.io/sidecar-injection` label being autogenerated on Mesh resources by bumping `shared-speakeasy/shared-speakeasy/customtypes` to `v0.2.4`
* Fix ZoneIngress and ZoneEgress resources not being Mesh scoped by bumping `shared-speakeasy/generators/resource_plan_modifier` to `v0.0.12`
...
### Features
* Add support for secrets, Zone Ingress, and Zone Egress endpoints in Mesh resources
...
* Fix invalid plans for computed attributes in mesh resources
