...
find examples/resources -type f -name "*.tf" | xargs sed -i '' 's/konnect-beta_/konnect_/'
find examples/resources -type f -name "*.sh" | xargs sed -i '' 's/konnect-beta_/konnect_/g'
find examples/resources -type f -name "*.tf" | grep -v "provider.tf" | xargs sed -i '' '1a\
