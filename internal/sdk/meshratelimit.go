...
func newMeshRateLimit(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MeshRateLimit {
...
func (s *MeshRateLimit) GetMeshRateLimit(ctx context.Context, request operations.GetMeshRateLimitRequest, opts ...operations.Option) (*operations.GetMeshRateLimitResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/mesh/control-planes/{cpId}/meshes/{mesh}/meshratelimits/{name}", request, nil)
	if err != nil {
...
func (s *MeshRateLimit) GetMeshRateLimitList(ctx context.Context, request operations.GetMeshRateLimitListRequest, opts ...operations.Option) (*operations.GetMeshRateLimitListResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/mesh/control-planes/{cpId}/meshes/{mesh}/meshratelimits", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
