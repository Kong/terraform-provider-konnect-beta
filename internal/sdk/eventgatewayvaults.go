...
func newEventGatewayVaults(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EventGatewayVaults {
...
func (s *EventGatewayVaults) CreateEventGatewayVault(ctx context.Context, request operations.CreateEventGatewayVaultRequest, opts ...operations.Option) (*operations.CreateEventGatewayVaultResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.EventGatewayVault
...
func (s *EventGatewayVaults) DeleteEventGatewayVault(ctx context.Context, request operations.DeleteEventGatewayVaultRequest, opts ...operations.Option) (*operations.DeleteEventGatewayVaultResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
