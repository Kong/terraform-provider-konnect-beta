...
func newEventGatewayBackendClusters(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EventGatewayBackendClusters {
...
func (s *EventGatewayBackendClusters) CreateEventGatewayBackendCluster(ctx context.Context, request operations.CreateEventGatewayBackendClusterRequest, opts ...operations.Option) (*operations.CreateEventGatewayBackendClusterResponse, error) {
...
func (s *EventGatewayBackendClusters) DeleteEventGatewayBackendCluster(ctx context.Context, request operations.DeleteEventGatewayBackendClusterRequest, opts ...operations.Option) (*operations.DeleteEventGatewayBackendClusterResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
