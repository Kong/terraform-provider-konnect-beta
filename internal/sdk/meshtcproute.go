...
func newMeshTCPRoute(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MeshTCPRoute {
	return &MeshTCPRoute{
		rootSDK:          rootSDK,
...
func (s *MeshTCPRoute) GetMeshTCPRoute(ctx context.Context, request operations.GetMeshTCPRouteRequest, opts ...operations.Option) (*operations.GetMeshTCPRouteResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/mesh/control-planes/{cpId}/meshes/{mesh}/meshtcproutes/{name}", request, nil)
	if err != nil {
...
func (s *MeshTCPRoute) GetMeshTCPRouteList(ctx context.Context, request operations.GetMeshTCPRouteListRequest, opts ...operations.Option) (*operations.GetMeshTCPRouteListResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/mesh/control-planes/{cpId}/meshes/{mesh}/meshtcproutes", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
