...
func newEventGatewayStaticKeys(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EventGatewayStaticKeys {
...
func (s *EventGatewayStaticKeys) CreateEventGatewayStaticKey(ctx context.Context, request operations.CreateEventGatewayStaticKeyRequest, opts ...operations.Option) (*operations.CreateEventGatewayStaticKeyResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.EventGatewayStaticKey
...
func (s *EventGatewayStaticKeys) GetEventGatewayStaticKey(ctx context.Context, request operations.GetEventGatewayStaticKeyRequest, opts ...operations.Option) (*operations.GetEventGatewayStaticKeyResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *EventGatewayStaticKeys) DeleteEventGatewayStaticKey(ctx context.Context, request operations.DeleteEventGatewayStaticKeyRequest, opts ...operations.Option) (*operations.DeleteEventGatewayStaticKeyResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
