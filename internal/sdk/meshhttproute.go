...
func newMeshHTTPRoute(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MeshHTTPRoute {
...
func (s *MeshHTTPRoute) GetMeshHTTPRoute(ctx context.Context, request operations.GetMeshHTTPRouteRequest, opts ...operations.Option) (*operations.GetMeshHTTPRouteResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/mesh/control-planes/{cpId}/meshes/{mesh}/meshhttproutes/{name}", request, nil)
	if err != nil {
...
func (s *MeshHTTPRoute) GetMeshHTTPRouteList(ctx context.Context, request operations.GetMeshHTTPRouteListRequest, opts ...operations.Option) (*operations.GetMeshHTTPRouteListResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/mesh/control-planes/{cpId}/meshes/{mesh}/meshhttproutes", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
