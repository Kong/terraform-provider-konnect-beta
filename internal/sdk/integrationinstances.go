...
func newIntegrationInstances(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *IntegrationInstances {
...
func (s *IntegrationInstances) CreateIntegrationInstance(ctx context.Context, request shared.CreateIntegrationInstance, opts ...operations.Option) (*operations.CreateIntegrationInstanceResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/service-catalog/integration-instances")
	if err != nil {
...
func (s *IntegrationInstances) FetchIntegrationInstance(ctx context.Context, request operations.FetchIntegrationInstanceRequest, opts ...operations.Option) (*operations.FetchIntegrationInstanceResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/service-catalog/integration-instances/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
