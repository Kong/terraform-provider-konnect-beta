...
func newPortalAuthSettings(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PortalAuthSettings {
...
func (s *PortalAuthSettings) CreatePortalIdentityProvider(ctx context.Context, request operations.CreatePortalIdentityProviderRequest, opts ...operations.Option) (*operations.CreatePortalIdentityProviderResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PortalIdentityProvider
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *PortalAuthSettings) GetPortalIdentityProvider(ctx context.Context, request operations.GetPortalIdentityProviderRequest, opts ...operations.Option) (*operations.GetPortalIdentityProviderResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
// from the portal.
func (s *PortalAuthSettings) DeletePortalIdentityProvider(ctx context.Context, request operations.DeletePortalIdentityProviderRequest, opts ...operations.Option) (*operations.DeletePortalIdentityProviderResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *PortalAuthSettings) CreatePortalIdpTeamGroupMapping(ctx context.Context, request operations.CreatePortalIdpTeamGroupMappingRequest, opts ...operations.Option) (*operations.CreatePortalIdpTeamGroupMappingResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PortalIdpTeamGroupMapping
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
