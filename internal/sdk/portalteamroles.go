...
func newPortalTeamRoles(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PortalTeamRoles {
...
func (s *PortalTeamRoles) AssignRoleToPortalTeams(ctx context.Context, request operations.AssignRoleToPortalTeamsRequest, opts ...operations.Option) (*operations.AssignRoleToPortalTeamsResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PortalAssignedRoleResponse
