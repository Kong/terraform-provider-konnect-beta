...
func newPortalAuditLogs(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PortalAuditLogs {
...
func (s *PortalAuditLogs) UpdatePortalAuditLogWebhook(ctx context.Context, request operations.UpdatePortalAuditLogWebhookRequest, opts ...operations.Option) (*operations.UpdatePortalAuditLogWebhookResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PortalAuditLogWebhook
...
func (s *PortalAuditLogs) GetPortalAuditLogWebhook(ctx context.Context, request operations.GetPortalAuditLogWebhookRequest, opts ...operations.Option) (*operations.GetPortalAuditLogWebhookResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *PortalAuditLogs) DeletePortalAuditLogWebhook(ctx context.Context, request operations.DeletePortalAuditLogWebhookRequest, opts ...operations.Option) (*operations.DeletePortalAuditLogWebhookResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
