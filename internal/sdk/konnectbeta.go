...
// Generated from OpenAPI doc version 2.0.0 and generator version 2.729.3
...
func New(opts ...SDKOption) *KonnectBeta {
	sdk := &KonnectBeta{
		SDKVersion: "0.11.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.11.2 2.729.3 2.0.0 github.com/kong/terraform-provider-konnect-beta/internal/sdk",
