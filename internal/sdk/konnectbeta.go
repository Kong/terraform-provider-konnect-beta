...
// Generated from OpenAPI doc version 2.0.0 and generator version 2.827.0
...
func New(opts ...SDKOption) *KonnectBeta {
	sdk := &KonnectBeta{
		SDKVersion: "0.15.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.15.0 2.827.0 2.0.0 github.com/kong/terraform-provider-konnect-beta/internal/sdk",
