...
func (d *DeleteAiGatewayMcpServerResponse) GetForbiddenError() *shared.ForbiddenError {
	if d == nil {
		return nil
	}
...
func (d *DeleteAiGatewayMcpServerResponse) GetNotFoundError() *shared.NotFoundError {
	if d == nil {
		return nil
	}
...
func (d *DeleteAiGatewayMcpServerResponse) GetTooManyRequestsError() *shared.TooManyRequestsError {
	if d == nil {
		return nil
	}
