...
func (c *CreateEventGatewayVirtualClusterProducePolicyModifyHeadersRequest) GetBefore() *string {
	if c == nil {
		return nil
	}
	return c.Before
...
func (c *CreateEventGatewayVirtualClusterProducePolicyModifyHeadersRequest) GetAfter() *string {
	if c == nil {
		return nil
	}
	return c.After
