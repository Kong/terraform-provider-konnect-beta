...
func (c *CreateEventGatewayVirtualClusterClusterLevelPolicyAclsRequest) GetBefore() *string {
	if c == nil {
		return nil
	}
	return c.Before
...
func (c *CreateEventGatewayVirtualClusterClusterLevelPolicyAclsRequest) GetAfter() *string {
	if c == nil {
		return nil
	}
	return c.After
