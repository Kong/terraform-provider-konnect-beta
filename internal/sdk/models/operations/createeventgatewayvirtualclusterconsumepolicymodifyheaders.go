...
func (c *CreateEventGatewayVirtualClusterConsumePolicyModifyHeadersRequest) GetBefore() *string {
	if c == nil {
		return nil
	}
	return c.Before
...
func (c *CreateEventGatewayVirtualClusterConsumePolicyModifyHeadersRequest) GetAfter() *string {
	if c == nil {
		return nil
	}
	return c.After
