...
func (g *GetDeveloperResponse) GetPortalDeveloper() *shared.PortalDeveloper {
	if g == nil {
		return nil
	}
...
func (g *GetDeveloperResponse) GetUnauthorizedError() *shared.UnauthorizedError {
	if g == nil {
		return nil
	}
...
func (g *GetDeveloperResponse) GetForbiddenError() *shared.ForbiddenError {
	if g == nil {
		return nil
	}
...
func (g *GetDeveloperResponse) GetNotFoundError() *shared.NotFoundError {
	if g == nil {
		return nil
	}
