...
func (c *CreateEventGatewayVirtualClusterConsumePolicySkipRecordRequest) GetBefore() *string {
	if c == nil {
		return nil
	}
	return c.Before
...
func (c *CreateEventGatewayVirtualClusterConsumePolicySkipRecordRequest) GetAfter() *string {
	if c == nil {
		return nil
	}
	return c.After
