...
func (a *AIGatewayMCPServerConversionListenerResponse) GetAccess() *AIGatewayMCPServerBaseACLProperties {
	if a == nil {
		return nil
	}
	return a.Access
...
func (a *AIGatewayMCPServerConversionListenerResponse) GetAccessConsumer() *AIGatewayMCPServerBaseACLPropertiesConsumer {
...
func (a *AIGatewayMCPServerConversionListenerResponse) GetAccessOauthAccessToken() *AIGatewayMCPServerBaseACLPropertiesOauth {
	if v := a.GetAccess(); v != nil {
