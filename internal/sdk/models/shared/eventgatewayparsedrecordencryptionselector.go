...
func (u *EventGatewayParsedRecordEncryptionSelectorPaths) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &arrayOfEventGatewayParsedRecordFieldPathsArray, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  EventGatewayParsedRecordEncryptionSelectorPathsTypeArrayOfEventGatewayParsedRecordFieldPathsArray,
	...
	if err := utils.UnmarshalJSON(data, &str, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  EventGatewayParsedRecordEncryptionSelectorPathsTypeStr,
			Value: &str,
		})
	}
	...
	u.Type = best.Type.(EventGatewayParsedRecordEncryptionSelectorPathsType)
	switch best.Type {
	case EventGatewayParsedRecordEncryptionSelectorPathsTypeArrayOfEventGatewayParsedRecordFieldPathsArray:
		u.ArrayOfEventGatewayParsedRecordFieldPathsArray = best.Value.([]EventGatewayParsedRecordFieldPathsArray)
		return nil
	case EventGatewayParsedRecordEncryptionSelectorPathsTypeStr:
