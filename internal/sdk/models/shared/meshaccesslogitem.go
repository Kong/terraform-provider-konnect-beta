...
// MeshAccessLogItemSpecFromFormat - Format of access logs. Placeholders available on
// https://www.envoyproxy.io/docs/envoy/latest/configuration/observability/access_log/usage#command-operators
type MeshAccessLogItemSpecFromFormat struct {
...
func (m MeshAccessLogItemSpecFromFormat) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(m, "", false)
}

func (m *MeshAccessLogItemSpecFromFormat) UnmarshalJSON(data []byte) error {
...
func (m *MeshAccessLogItemSpecFromFormat) GetJSON() []JSON {
	if m == nil {
		return nil
	}
	return m.JSON
...
func (m *MeshAccessLogItemSpecFromFormat) GetOmitEmptyValues() *bool {
	if m == nil {
		return nil
	}
...
func (m *MeshAccessLogItemSpecFromFormat) GetPlain() *string {
	if m == nil {
		return nil
	}
	return m.Plain
...
func (m *MeshAccessLogItemSpecFromFormat) GetType() MeshAccessLogItemSpecFromDefaultType {
	if m == nil {
...
type File struct {
	...
	// https://www.envoyproxy.io/docs/envoy/latest/configuration/observability/access_log/usage#command-operators
	Format *MeshAccessLogItemSpecFromFormat `json:"format,omitempty"`
	// Path to a file that logs will be written to
	Path string `json:"path"`
}

func (f *File) GetFormat() *MeshAccessLogItemSpecFromFormat {
	if f == nil {
		return nil
	}
	return f.Format
