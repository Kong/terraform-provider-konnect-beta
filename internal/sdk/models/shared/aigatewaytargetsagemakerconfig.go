...
func (t *Target) GetVariant() *string {
	if t == nil {
		return nil
	}
	return t.Variant
...
func (t *Target) GetContainerHostname() *string {
	if t == nil {
		return nil
	}
	return t.ContainerHostname
}
...
func (a *AIGatewayTargetSagemakerConfig) GetTarget() *Target {
	if a == nil {
		return nil
	}
	return a.Target
