...
func (u *EventGatewayVault) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &eventGatewayVaultEventGatewayEnvVault, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  EventGatewayVaultTypeEventGatewayVaultEventGatewayEnvVault,
			Value: &eventGatewayVaultEventGatewayEnvVault,
		})
	}
	...
	if err := utils.UnmarshalJSON(data, &eventGatewayVaultEventGatewayKonnectVault, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  EventGatewayVaultTypeEventGatewayVaultEventGatewayKonnectVault,
			Value: &eventGatewayVaultEventGatewayKonnectVault,
		})
	}
	...
	u.Type = best.Type.(EventGatewayVaultType)
	switch best.Type {
	case EventGatewayVaultTypeEventGatewayVaultEventGatewayEnvVault:
		u.EventGatewayVaultEventGatewayEnvVault = best.Value.(*EventGatewayVaultEventGatewayEnvVault)
		return nil
	case EventGatewayVaultTypeEventGatewayVaultEventGatewayKonnectVault:
		u.EventGatewayVaultEventGatewayKonnectVault = best.Value.(*EventGatewayVaultEventGatewayKonnectVault)
		return nil
	}
