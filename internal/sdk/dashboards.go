...
func newDashboards(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Dashboards {
	return &Dashboards{
		rootSDK:          rootSDK,
...
func (s *Dashboards) DashboardsCreate(ctx context.Context, request shared.DashboardUpdateRequest, opts ...operations.Option) (*operations.DashboardsCreateResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.DashboardResponse
...
func (s *Dashboards) DashboardsGet(ctx context.Context, request operations.DashboardsGetRequest, opts ...operations.Option) (*operations.DashboardsGetResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Dashboards) DashboardsUpdate(ctx context.Context, request operations.DashboardsUpdateRequest, opts ...operations.Option) (*operations.DashboardsUpdateResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Dashboards) DashboardsDelete(ctx context.Context, request operations.DashboardsDeleteRequest, opts ...operations.Option) (*operations.DashboardsDeleteResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
