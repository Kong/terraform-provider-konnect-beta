...
func newEventGatewayDataPlaneCertificates(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EventGatewayDataPlaneCertificates {
...
func (s *EventGatewayDataPlaneCertificates) CreateEventGatewayDataPlaneCertificate(ctx context.Context, request operations.CreateEventGatewayDataPlaneCertificateRequest, opts ...operations.Option) (*operations.CreateEventGatewayDataPlaneCertificateResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.EventGatewayDataPlaneCertificate
...
func (s *EventGatewayDataPlaneCertificates) DeleteEventGatewayDataPlaneCertificate(ctx context.Context, request operations.DeleteEventGatewayDataPlaneCertificateRequest, opts ...operations.Option) (*operations.DeleteEventGatewayDataPlaneCertificateResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
