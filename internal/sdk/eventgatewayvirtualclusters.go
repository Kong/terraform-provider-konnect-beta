...
func newEventGatewayVirtualClusters(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EventGatewayVirtualClusters {
...
func (s *EventGatewayVirtualClusters) CreateEventGatewayVirtualCluster(ctx context.Context, request operations.CreateEventGatewayVirtualClusterRequest, opts ...operations.Option) (*operations.CreateEventGatewayVirtualClusterResponse, error) {
...
func (s *EventGatewayVirtualClusters) DeleteEventGatewayVirtualCluster(ctx context.Context, request operations.DeleteEventGatewayVirtualClusterRequest, opts ...operations.Option) (*operations.DeleteEventGatewayVirtualClusterResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
