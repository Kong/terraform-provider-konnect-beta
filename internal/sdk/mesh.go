...
func newMesh(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Mesh {
	return &Mesh{
		rootSDK:          rootSDK,
...
func (s *Mesh) GetMeshList(ctx context.Context, request operations.GetMeshListRequest, opts ...operations.Option) (*operations.GetMeshListResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/mesh/control-planes/{cpId}/meshes", request, nil)
	if err != nil {
...
func (s *Mesh) DeleteMesh(ctx context.Context, request operations.DeleteMeshRequest, opts ...operations.Option) (*operations.DeleteMeshResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/mesh/control-planes/{cpId}/meshes/{name}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Mesh) ListMeshControlPlanes(ctx context.Context, request operations.ListMeshControlPlanesRequest, opts ...operations.Option) (*operations.ListMeshControlPlanesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v3/mesh/control-planes")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res.Next = func() (*operations.ListMeshControlPlanesResponse, error) {
		rawBody, err := utils.ConsumeRawBody(httpRes)
		if err != nil {
			return nil, err
		}
...
func (s *Mesh) GetMeshControlPlane(ctx context.Context, request operations.GetMeshControlPlaneRequest, opts ...operations.Option) (*operations.GetMeshControlPlaneResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/mesh/control-planes/{cpId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
