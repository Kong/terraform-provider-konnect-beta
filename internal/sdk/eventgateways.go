...
func newEventGateways(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *EventGateways {
...
func (s *EventGateways) CreateEventGateway(ctx context.Context, request shared.CreateGatewayRequest, opts ...operations.Option) (*operations.CreateEventGatewayResponse, error) {
...
func (s *EventGateways) GetEventGateway(ctx context.Context, request operations.GetEventGatewayRequest, opts ...operations.Option) (*operations.GetEventGatewayResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *EventGateways) DeleteEventGateway(ctx context.Context, request operations.DeleteEventGatewayRequest, opts ...operations.Option) (*operations.DeleteEventGatewayResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
