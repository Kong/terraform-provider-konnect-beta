...
func newCatalogResources(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CatalogResources {
...
func (s *CatalogResources) InitializeResource(ctx context.Context, request operations.InitializeResourceRequest, opts ...operations.Option) (*operations.InitializeResourceResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/service-catalog/integration-instances/{integrationInstanceId}/resources", request, nil)
	if err != nil {
