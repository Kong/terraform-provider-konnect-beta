...
func newCatalogServices(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CatalogServices {
...
func (s *CatalogServices) CreateCatalogService(ctx context.Context, request shared.CreateCatalogService, opts ...operations.Option) (*operations.CreateCatalogServiceResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/service-catalog/services")
	if err != nil {
...
func (s *CatalogServices) FetchCatalogService(ctx context.Context, request operations.FetchCatalogServiceRequest, opts ...operations.Option) (*operations.FetchCatalogServiceResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/service-catalog/services/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
