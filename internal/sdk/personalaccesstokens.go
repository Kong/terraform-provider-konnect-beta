...
func newPersonalAccessTokens(rootSDK *KonnectBeta, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PersonalAccessTokens {
...
func (s *PersonalAccessTokens) GetOrganizationsPersonalAccessTokenSettings(ctx context.Context, request operations.GetOrganizationsPersonalAccessTokenSettingsRequest, opts ...operations.Option) (*operations.GetOrganizationsPersonalAccessTokenSettingsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/organizations/{organizationId}/personal-access-token-settings", request, nil)
	if err != nil {
	...
	res := &operations.GetOrganizationsPersonalAccessTokenSettingsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PersonalAccessTokenSettingsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PersonalAccessTokenSettingsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *PersonalAccessTokens) UpdatePersonalAccessTokenSettings(ctx context.Context, request operations.UpdatePersonalAccessTokenSettingsRequest, opts ...operations.Option) (*operations.UpdatePersonalAccessTokenSettingsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "PersonalAccessTokenSettingsUpdateRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.UpdatePersonalAccessTokenSettingsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
