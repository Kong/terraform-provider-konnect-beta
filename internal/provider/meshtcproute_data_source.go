...
var _ datasource.DataSource = &MeshTCPRouteDataSource{}
var _ datasource.DataSourceWithConfigure = &MeshTCPRouteDataSource{}

func NewMeshTCPRouteDataSource() datasource.DataSource {
	return &MeshTCPRouteDataSource{}
}

// MeshTCPRouteDataSource is the data source implementation.
type MeshTCPRouteDataSource struct {
	client *sdk.KonnectBeta
}

// MeshTCPRouteDataSourceModel describes the data model.
type MeshTCPRouteDataSourceModel struct {
...
func (r *MeshTCPRouteDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mesh_tcp_route"
}

// Schema defines the schema for the data source.
func (r *MeshTCPRouteDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "MeshTCPRoute DataSource",
...
func (r *MeshTCPRouteDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *MeshTCPRouteDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *MeshTCPRouteDataSourceModel
