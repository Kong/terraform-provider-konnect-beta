...
var _ datasource.DataSource = &MeshServiceDataSource{}
var _ datasource.DataSourceWithConfigure = &MeshServiceDataSource{}

func NewMeshServiceDataSource() datasource.DataSource {
	return &MeshServiceDataSource{}
}

// MeshServiceDataSource is the data source implementation.
type MeshServiceDataSource struct {
...
func (r *MeshServiceDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mesh_service"
}

// Schema defines the schema for the data source.
func (r *MeshServiceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "MeshService DataSource",
...
func (r *MeshServiceDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *MeshServiceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *MeshServiceDataSourceModel
