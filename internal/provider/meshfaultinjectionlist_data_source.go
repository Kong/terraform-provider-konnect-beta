...
func (r *MeshFaultInjectionListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	request, requestDiags := data.ToOperationsGetMeshFaultInjectionListRequest(ctx)
	...
	resp.Diagnostics.Append(data.RefreshFromSharedMeshFaultInjectionList(ctx, res.MeshFaultInjectionList)...)
