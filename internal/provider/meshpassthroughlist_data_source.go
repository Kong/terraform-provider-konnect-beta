...
var _ datasource.DataSource = &MeshPassthroughListDataSource{}
var _ datasource.DataSourceWithConfigure = &MeshPassthroughListDataSource{}

func NewMeshPassthroughListDataSource() datasource.DataSource {
	return &MeshPassthroughListDataSource{}
}
...
// MeshPassthroughListDataSourceModel describes the data model.
...
func (r *MeshPassthroughListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mesh_passthrough_list"
}

// Schema defines the schema for the data source.
func (r *MeshPassthroughListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "MeshPassthroughList DataSource",
...
func (r *MeshPassthroughListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *MeshPassthroughListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *MeshPassthroughListDataSourceModel
	...
	request, requestDiags := data.ToOperationsGetMeshPassthroughListRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.MeshPassthrough.GetMeshPassthroughList(ctx, *request)
	if err != nil {
	...
	if !(res.MeshPassthroughList != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedMeshPassthroughList(ctx, res.MeshPassthroughList)...)
