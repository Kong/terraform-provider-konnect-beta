...
func (r *EventGatewayBackendClusterResourceModel) RefreshFromSharedBackendCluster(ctx context.Context, resp *shared.BackendCluster) diag.Diagnostics {
	...
	if resp != nil {
		if resp.Authentication.BackendClusterAuthenticationAnonymous != nil {
			...
			r.Authentication.Anonymous.Type = types.StringValue(string(resp.Authentication.BackendClusterAuthenticationAnonymous.Type))
		}
		if resp.Authentication.BackendClusterAuthenticationSaslPlain != nil {
			...
			r.Authentication.SaslPlain.Type = types.StringValue(string(resp.Authentication.BackendClusterAuthenticationSaslPlain.Type))
		...
		if resp.Authentication.BackendClusterAuthenticationSaslScram != nil {
			...
			r.Authentication.SaslScram.Type = types.StringValue(string(resp.Authentication.BackendClusterAuthenticationSaslScram.Type))
...
func (r *EventGatewayBackendClusterResourceModel) ToSharedCreateBackendClusterRequest(ctx context.Context) (*shared.CreateBackendClusterRequest, diag.Diagnostics) {
	...
	if r.Authentication.Anonymous != nil {
		typeVar := shared.BackendClusterAuthenticationAnonymousType(r.Authentication.Anonymous.Type.ValueString())
	...
	if r.Authentication.SaslPlain != nil {
		typeVar1 := shared.BackendClusterAuthenticationSaslPlainType(r.Authentication.SaslPlain.Type.ValueString())
		var username string
	...
	if r.Authentication.SaslScram != nil {
		typeVar2 := shared.BackendClusterAuthenticationSaslScramType(r.Authentication.SaslScram.Type.ValueString())
