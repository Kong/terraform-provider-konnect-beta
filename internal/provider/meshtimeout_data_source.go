...
var _ datasource.DataSource = &MeshTimeoutDataSource{}
var _ datasource.DataSourceWithConfigure = &MeshTimeoutDataSource{}

func NewMeshTimeoutDataSource() datasource.DataSource {
	return &MeshTimeoutDataSource{}
}
...
// MeshTimeoutDataSourceModel describes the data model.
type MeshTimeoutDataSourceModel struct {
...
func (r *MeshTimeoutDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mesh_timeout"
}

// Schema defines the schema for the data source.
func (r *MeshTimeoutDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "MeshTimeout DataSource",
...
func (r *MeshTimeoutDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *MeshTimeoutDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *MeshTimeoutDataSourceModel
