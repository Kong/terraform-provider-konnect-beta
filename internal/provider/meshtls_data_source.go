...
var _ datasource.DataSource = &MeshTLSDataSource{}
var _ datasource.DataSourceWithConfigure = &MeshTLSDataSource{}

func NewMeshTLSDataSource() datasource.DataSource {
	return &MeshTLSDataSource{}
}

// MeshTLSDataSource is the data source implementation.
type MeshTLSDataSource struct {
	client *sdk.KonnectBeta
}

// MeshTLSDataSourceModel describes the data model.
type MeshTLSDataSourceModel struct {
...
func (r *MeshTLSDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mesh_tls"
}

// Schema defines the schema for the data source.
func (r *MeshTLSDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "MeshTLS DataSource",
...
func (r *MeshTLSDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *MeshTLSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *MeshTLSDataSourceModel
