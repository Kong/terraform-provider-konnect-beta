...
var _ datasource.DataSource = &MeshCircuitBreakerDataSource{}
var _ datasource.DataSourceWithConfigure = &MeshCircuitBreakerDataSource{}

func NewMeshCircuitBreakerDataSource() datasource.DataSource {
	return &MeshCircuitBreakerDataSource{}
}
...
func (r *MeshCircuitBreakerDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mesh_circuit_breaker"
}

// Schema defines the schema for the data source.
func (r *MeshCircuitBreakerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *MeshCircuitBreakerDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *MeshCircuitBreakerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *MeshCircuitBreakerDataSourceModel
