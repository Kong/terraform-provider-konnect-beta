...
type AIGatewayIdentityProviderOpenIDConnectConfig struct {
	...
	DownstreamHeaders                            []DownstreamHeaders                               `tfsdk:"downstream_headers"`
	...
	Principals                                   *AIGatewayIdentityProviderOpenIDConnectPrincipals `tfsdk:"principals"`
	...
	UpstreamHeaders                              []DownstreamHeaders                               `tfsdk:"upstream_headers"`
