...
type MeshRetryItemHTTP struct {
	...
	RetriableRequestHeaders  []MeshHTTPRouteItemHeaders `tfsdk:"retriable_request_headers"`
	RetriableResponseHeaders []MeshHTTPRouteItemHeaders `tfsdk:"retriable_response_headers"`
