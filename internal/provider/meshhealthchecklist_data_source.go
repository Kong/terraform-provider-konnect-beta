...
func (r *MeshHealthCheckListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	request, requestDiags := data.ToOperationsGetMeshHealthCheckListRequest(ctx)
	...
	resp.Diagnostics.Append(data.RefreshFromSharedMeshHealthCheckList(ctx, res.MeshHealthCheckList)...)
