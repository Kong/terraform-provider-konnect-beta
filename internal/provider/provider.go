...
func (p *KonnectBetaProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewEventGatewayVirtualClusterClusterPolicyAclsResource,
		NewEventGatewayVirtualClusterConsumePolicyDecryptResource,
		NewEventGatewayVirtualClusterConsumePolicyModifyHeadersResource,
		NewEventGatewayVirtualClusterConsumePolicySchemaValidationResource,
		NewEventGatewayVirtualClusterConsumePolicySkipRecordResource,
		NewEventGatewayVirtualClusterProducePolicyEncryptResource,
		NewEventGatewayVirtualClusterProducePolicyModifyHeadersResource,
		NewEventGatewayVirtualClusterProducePolicySchemaValidationResource,
		NewEventGatewayVirtualClusterProducePolicySkipRecordResource,
		NewMeshResource,
