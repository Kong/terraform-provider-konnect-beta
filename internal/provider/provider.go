...
func (p *KonnectBetaProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewEventGatewayListenerPolicyResource,
		NewEventGatewaySchemaRegistryResource,
		NewEventGatewayVaultResource,
		NewEventGatewayVirtualClusterResource,
		NewEventGatewayVirtualClusterClusterPolicyResource,
		NewEventGatewayVirtualClusterConsumePolicyResource,
		NewEventGatewayVirtualClusterProducePolicyResource,
		NewMeshResource,
