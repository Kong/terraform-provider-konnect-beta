...
func (p *KonnectBetaProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewAIGatewayResource,
		NewAIGatewayAgentResource,
		NewAIGatewayAuthStrategyResource,
		NewAIGatewayCACertificateResource,
		NewAIGatewayCertificateResource,
		NewAIGatewayConfigStoreResource,
		NewAIGatewayConfigStoreSecretResource,
		NewAIGatewayConsumerResource,
		...
		NewAIGatewayIdentityProviderResource,
		NewAIGatewayMCPServerResource,
		NewAIGatewayModelResource,
		NewAIGatewayModelProviderResource,
		NewAIGatewayPolicyResource,
		NewAIGatewaySNIResource,
		NewAIGatewayVaultResource,
		NewAPIResource,
		...
		NewEventGatewayConsumePolicyDecryptFieldsResource,
		...
		NewEventGatewayProducePolicyEncryptFieldsResource,
