...
func (r *MeshTCPRouteListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	request, requestDiags := data.ToOperationsGetMeshTCPRouteListRequest(ctx)
	...
	resp.Diagnostics.Append(data.RefreshFromSharedMeshTCPRouteList(ctx, res.MeshTCPRouteList)...)
