...
func (r *MeshLoadBalancingStrategyListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	request, requestDiags := data.ToOperationsGetMeshLoadBalancingStrategyListRequest(ctx)
	...
	resp.Diagnostics.Append(data.RefreshFromSharedMeshLoadBalancingStrategyList(ctx, res.MeshLoadBalancingStrategyList)...)
