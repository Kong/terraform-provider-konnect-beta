...
var _ datasource.DataSource = &MeshRetryListDataSource{}
var _ datasource.DataSourceWithConfigure = &MeshRetryListDataSource{}

func NewMeshRetryListDataSource() datasource.DataSource {
	return &MeshRetryListDataSource{}
}

// MeshRetryListDataSource is the data source implementation.
type MeshRetryListDataSource struct {
	client *sdk.KonnectBeta
}

// MeshRetryListDataSourceModel describes the data model.
...
func (r *MeshRetryListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mesh_retry_list"
}

// Schema defines the schema for the data source.
func (r *MeshRetryListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "MeshRetryList DataSource",
...
func (r *MeshRetryListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *MeshRetryListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *MeshRetryListDataSourceModel
	...
	request := operations.GetMeshRetryListRequest{
		CpID:   cpID,
		Offset: offset,
		Size:   size,
		Filter: filter,
	...
	res, err := r.client.MeshRetry.GetMeshRetryList(ctx, request)
	if err != nil {
	...
	if !(res.MeshRetryList != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	data.RefreshFromSharedMeshRetryList(res.MeshRetryList)
