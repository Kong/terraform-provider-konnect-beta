...
var _ datasource.DataSource = &MeshHTTPRouteDataSource{}
var _ datasource.DataSourceWithConfigure = &MeshHTTPRouteDataSource{}

func NewMeshHTTPRouteDataSource() datasource.DataSource {
	return &MeshHTTPRouteDataSource{}
}
...
// MeshHTTPRouteDataSourceModel describes the data model.
type MeshHTTPRouteDataSourceModel struct {
...
func (r *MeshHTTPRouteDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mesh_http_route"
}

// Schema defines the schema for the data source.
func (r *MeshHTTPRouteDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "MeshHTTPRoute DataSource",
...
func (r *MeshHTTPRouteDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *MeshHTTPRouteDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *MeshHTTPRouteDataSourceModel
