...
var _ datasource.DataSource = &MeshHealthCheckDataSource{}
var _ datasource.DataSourceWithConfigure = &MeshHealthCheckDataSource{}

func NewMeshHealthCheckDataSource() datasource.DataSource {
	return &MeshHealthCheckDataSource{}
}
...
// MeshHealthCheckDataSourceModel describes the data model.
type MeshHealthCheckDataSourceModel struct {
...
func (r *MeshHealthCheckDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mesh_health_check"
}

// Schema defines the schema for the data source.
func (r *MeshHealthCheckDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "MeshHealthCheck DataSource",
...
func (r *MeshHealthCheckDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *MeshHealthCheckDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *MeshHealthCheckDataSourceModel
