	...
	if resp != nil {
		if resp.AIGatewayIdentityProviderKeyAuthResponse != nil {
			...
			if resp.AIGatewayIdentityProviderKeyAuthResponse.Config == nil {
				...
				if resp.AIGatewayIdentityProviderKeyAuthResponse.Config.Principals == nil {
					r.KeyAuth.Config.Principals = nil
				} else {
					r.KeyAuth.Config.Principals = &tfTypes.Principals{}
					r.KeyAuth.Config.Principals.Directory = types.StringPointerValue(resp.AIGatewayIdentityProviderKeyAuthResponse.Config.Principals.Directory)
					r.KeyAuth.Config.Principals.Enabled = types.BoolPointerValue(resp.AIGatewayIdentityProviderKeyAuthResponse.Config.Principals.Enabled)
					r.KeyAuth.Config.Principals.ErrorOnMiss = types.BoolPointerValue(resp.AIGatewayIdentityProviderKeyAuthResponse.Config.Principals.ErrorOnMiss)
				}
				r.KeyAuth.Config.Realm = types.StringPointerValue(resp.AIGatewayIdentityProviderKeyAuthResponse.Config.Realm)
				r.KeyAuth.Config.RunOnPreflight = types.BoolPointerValue(resp.AIGatewayIdentityProviderKeyAuthResponse.Config.RunOnPreflight)
			}
		...
		if resp.AIGatewayIdentityProviderOpenIDConnectResponse != nil {
			...
			if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config == nil {
				...
				r.OpenidConnect.Config.AuthorizationCookieName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.AuthorizationCookieName)
				r.OpenidConnect.Config.AuthorizationCookiePath = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.AuthorizationCookiePath)
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.AuthorizationCookieSameSite != nil {
					r.OpenidConnect.Config.AuthorizationCookieSameSite = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.AuthorizationCookieSameSite))
				} else {
				...
				r.OpenidConnect.Config.BearerTokenHeaderName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.BearerTokenHeaderName)
				r.OpenidConnect.Config.BearerTokenParamType = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.BearerTokenParamType))
				for _, v := range resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.BearerTokenParamType {
				...
				r.OpenidConnect.Config.ByUsernameIgnoreCase = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ByUsernameIgnoreCase)
				r.OpenidConnect.Config.CacheIntrospection = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.CacheIntrospection)
				r.OpenidConnect.Config.CacheTokenExchange = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.CacheTokenExchange)
				r.OpenidConnect.Config.CacheTokens = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.CacheTokens)
				...
				r.OpenidConnect.Config.CacheTTL = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.CacheTTL)
				r.OpenidConnect.Config.CacheTTLMax = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.CacheTTLMax)
				r.OpenidConnect.Config.CacheTTLMin = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.CacheTTLMin)
				...
				for _, v := range resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheItems {
					r.OpenidConnect.Config.ClusterCacheItems = append(r.OpenidConnect.Config.ClusterCacheItems, types.StringValue(string(v)))
				}
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis == nil {
					r.OpenidConnect.Config.ClusterCacheRedis = nil
				} else {
					r.OpenidConnect.Config.ClusterCacheRedis = &tfTypes.ClusterCacheRedis{}
					if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication == nil {
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication = nil
					} else {
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication = &tfTypes.AIGatewayIdentityProviderOpenIDConnectCloudAuthentication{}
						if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AuthProvider != nil {
							r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AuthProvider = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AuthProvider))
						} else {
							r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AuthProvider = types.StringNull()
						}
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AwsAccessKeyID = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AwsAccessKeyID)
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AwsAssumeRoleArn = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AwsAssumeRoleArn)
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AwsCacheName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AwsCacheName)
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AwsIsServerless = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AwsIsServerless)
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AwsRegion = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AwsRegion)
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AwsRoleSessionName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AwsRoleSessionName)
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AwsSecretAccessKey = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AwsSecretAccessKey)
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AzureClientID = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AzureClientID)
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AzureClientSecret = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AzureClientSecret)
						r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication.AzureTenantID = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.CloudAuthentication.AzureTenantID)
					...
					r.OpenidConnect.Config.ClusterCacheRedis.Database = types.Int64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.Database)
					r.OpenidConnect.Config.ClusterCacheRedis.Host = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.Host)
					r.OpenidConnect.Config.ClusterCacheRedis.KeepaliveBacklog = types.Int64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.KeepaliveBacklog)
					r.OpenidConnect.Config.ClusterCacheRedis.KeepalivePoolSize = types.Int64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.KeepalivePoolSize)
					r.OpenidConnect.Config.ClusterCacheRedis.Password = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.Password)
					r.OpenidConnect.Config.ClusterCacheRedis.Port = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.Port)
					...
					if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.SentinelRole != nil {
						r.OpenidConnect.Config.ClusterCacheRedis.SentinelRole = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.SentinelRole))
					} else {
						r.OpenidConnect.Config.ClusterCacheRedis.SentinelRole = types.StringNull()
					}
					r.OpenidConnect.Config.ClusterCacheRedis.SentinelUsername = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.SentinelUsername)
					r.OpenidConnect.Config.ClusterCacheRedis.ServerName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.ServerName)
					r.OpenidConnect.Config.ClusterCacheRedis.Ssl = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.Ssl)
					r.OpenidConnect.Config.ClusterCacheRedis.SslVerify = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.SslVerify)
					r.OpenidConnect.Config.ClusterCacheRedis.Username = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheRedis.Username)
				}
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheStrategy != nil {
					r.OpenidConnect.Config.ClusterCacheStrategy = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ClusterCacheStrategy))
				} else {
					r.OpenidConnect.Config.ClusterCacheStrategy = types.StringNull()
				}
				r.OpenidConnect.Config.ConsumerBy = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ConsumerBy))
				...
				r.OpenidConnect.Config.CredentialClaim = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.CredentialClaim))
				...
				r.OpenidConnect.Config.DownstreamIntrospectionHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.DownstreamIntrospectionHeader)
				r.OpenidConnect.Config.DownstreamIntrospectionJwtHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.DownstreamIntrospectionJwtHeader)
				r.OpenidConnect.Config.DownstreamRefreshTokenHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.DownstreamRefreshTokenHeader)
				r.OpenidConnect.Config.DownstreamSessionIDHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.DownstreamSessionIDHeader)
				r.OpenidConnect.Config.DownstreamUserInfoHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.DownstreamUserInfoHeader)
				r.OpenidConnect.Config.DownstreamUserInfoJwtHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.DownstreamUserInfoJwtHeader)
				r.OpenidConnect.Config.DpopProofLifetime = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.DpopProofLifetime)
				r.OpenidConnect.Config.DpopUseNonce = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.DpopUseNonce)
				...
				r.OpenidConnect.Config.HTTPProxyAuthorization = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.HTTPProxyAuthorization)
				r.OpenidConnect.Config.HTTPVersion = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.HTTPVersion)
				r.OpenidConnect.Config.HTTPSProxy = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.HTTPSProxy)
				r.OpenidConnect.Config.HTTPSProxyAuthorization = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.HTTPSProxyAuthorization)
				r.OpenidConnect.Config.IDTokenParamName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IDTokenParamName)
				r.OpenidConnect.Config.IDTokenParamType = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IDTokenParamType))
				for _, v := range resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IDTokenParamType {
					r.OpenidConnect.Config.IDTokenParamType = append(r.OpenidConnect.Config.IDTokenParamType, types.StringValue(string(v)))
				}
				r.OpenidConnect.Config.IgnoreSignature = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IgnoreSignature))
				for _, v := range resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IgnoreSignature {
					r.OpenidConnect.Config.IgnoreSignature = append(r.OpenidConnect.Config.IgnoreSignature, types.StringValue(string(v)))
				}
				r.OpenidConnect.Config.IntrospectJwtTokens = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IntrospectJwtTokens)
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IntrospectionAccept != nil {
					r.OpenidConnect.Config.IntrospectionAccept = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IntrospectionAccept))
				} else {
					r.OpenidConnect.Config.IntrospectionAccept = types.StringNull()
				}
				r.OpenidConnect.Config.IntrospectionCheckActive = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IntrospectionCheckActive)
				r.OpenidConnect.Config.IntrospectionEndpoint = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IntrospectionEndpoint)
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IntrospectionEndpointAuthMethod != nil {
					r.OpenidConnect.Config.IntrospectionEndpointAuthMethod = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.IntrospectionEndpointAuthMethod))
				} else {
				...
				r.OpenidConnect.Config.JwtSessionCookie = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.JwtSessionCookie)
				r.OpenidConnect.Config.Keepalive = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Keepalive)
				r.OpenidConnect.Config.Leeway = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Leeway)
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.LoginAction != nil {
					r.OpenidConnect.Config.LoginAction = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.LoginAction))
				} else {
					r.OpenidConnect.Config.LoginAction = types.StringNull()
				}
				r.OpenidConnect.Config.LoginMethods = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.LoginMethods))
				for _, v := range resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.LoginMethods {
					r.OpenidConnect.Config.LoginMethods = append(r.OpenidConnect.Config.LoginMethods, types.StringValue(string(v)))
				}
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.LoginRedirectMode != nil {
					r.OpenidConnect.Config.LoginRedirectMode = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.LoginRedirectMode))
				} else {
				...
				r.OpenidConnect.Config.LogoutMethods = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.LogoutMethods))
				for _, v := range resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.LogoutMethods {
				...
				r.OpenidConnect.Config.LogoutRevokeRefreshToken = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.LogoutRevokeRefreshToken)
				r.OpenidConnect.Config.LogoutURISuffix = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.LogoutURISuffix)
				r.OpenidConnect.Config.MaxAge = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.MaxAge)
				r.OpenidConnect.Config.MtlsIntrospectionEndpoint = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.MtlsIntrospectionEndpoint)
				r.OpenidConnect.Config.MtlsRevocationEndpoint = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.MtlsRevocationEndpoint)
				r.OpenidConnect.Config.MtlsTokenEndpoint = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.MtlsTokenEndpoint)
				r.OpenidConnect.Config.NoProxy = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.NoProxy)
				r.OpenidConnect.Config.PasswordParamType = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.PasswordParamType))
				for _, v := range resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.PasswordParamType {
					r.OpenidConnect.Config.PasswordParamType = append(r.OpenidConnect.Config.PasswordParamType, types.StringValue(string(v)))
				}
				r.OpenidConnect.Config.PreserveQueryArgs = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.PreserveQueryArgs)
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Principals == nil {
					r.OpenidConnect.Config.Principals = nil
				} else {
					r.OpenidConnect.Config.Principals = &tfTypes.AIGatewayIdentityProviderOpenIDConnectPrincipals{}
					r.OpenidConnect.Config.Principals.Directory = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Principals.Directory)
					r.OpenidConnect.Config.Principals.Enabled = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Principals.Enabled)
					r.OpenidConnect.Config.Principals.ErrorOnMiss = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Principals.ErrorOnMiss)
				...
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionDpop != nil {
					r.OpenidConnect.Config.ProofOfPossessionDpop = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionDpop))
				} else {
					r.OpenidConnect.Config.ProofOfPossessionDpop = types.StringNull()
				}
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtls != nil {
					r.OpenidConnect.Config.ProofOfPossessionMtls = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtls))
				} else {
					r.OpenidConnect.Config.ProofOfPossessionMtls = types.StringNull()
				}
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader == nil {
					...
					r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.AllowPartialChain = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.AllowPartialChain)
					r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.CaCertificates = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.CaCertificates))
					for _, v := range resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.CaCertificates {
					...
					r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.CertCacheTTL = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.CertCacheTTL)
					if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.CertificateHeaderFormat != nil {
						r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.CertificateHeaderFormat = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.CertificateHeaderFormat))
					} else {
						r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.CertificateHeaderFormat = types.StringNull()
					}
					r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.CertificateHeaderName = types.StringValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.CertificateHeaderName)
					r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.HTTPProxyHost = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.HTTPProxyHost)
					r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.HTTPProxyPort = types.Int64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.HTTPProxyPort)
					r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.HTTPTimeout = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.HTTPTimeout)
					r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.HTTPSProxyHost = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.HTTPSProxyHost)
					r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.HTTPSProxyPort = types.Int64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.HTTPSProxyPort)
					if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.RevocationCheckMode != nil {
						r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.RevocationCheckMode = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.RevocationCheckMode))
					} else {
						r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.RevocationCheckMode = types.StringNull()
					}
					r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.SecureSource = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.SecureSource)
					r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.SslVerify = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ProofOfPossessionMtlsFromHeader.SslVerify)
				}
				r.OpenidConnect.Config.PushedAuthorizationRequestEndpoint = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.PushedAuthorizationRequestEndpoint)
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.PushedAuthorizationRequestEndpointAuthMethod != nil {
					r.OpenidConnect.Config.PushedAuthorizationRequestEndpointAuthMethod = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.PushedAuthorizationRequestEndpointAuthMethod))
				} else {
				...
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis == nil {
					...
					if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication == nil {
						r.OpenidConnect.Config.Redis.CloudAuthentication = nil
					} else {
						r.OpenidConnect.Config.Redis.CloudAuthentication = &tfTypes.AIGatewayIdentityProviderOpenIDConnectCloudAuthentication{}
						if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AuthProvider != nil {
							r.OpenidConnect.Config.Redis.CloudAuthentication.AuthProvider = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AuthProvider))
						} else {
							r.OpenidConnect.Config.Redis.CloudAuthentication.AuthProvider = types.StringNull()
						}
						r.OpenidConnect.Config.Redis.CloudAuthentication.AwsAccessKeyID = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AwsAccessKeyID)
						r.OpenidConnect.Config.Redis.CloudAuthentication.AwsAssumeRoleArn = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AwsAssumeRoleArn)
						r.OpenidConnect.Config.Redis.CloudAuthentication.AwsCacheName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AwsCacheName)
						r.OpenidConnect.Config.Redis.CloudAuthentication.AwsIsServerless = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AwsIsServerless)
						r.OpenidConnect.Config.Redis.CloudAuthentication.AwsRegion = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AwsRegion)
						r.OpenidConnect.Config.Redis.CloudAuthentication.AwsRoleSessionName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AwsRoleSessionName)
						r.OpenidConnect.Config.Redis.CloudAuthentication.AwsSecretAccessKey = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AwsSecretAccessKey)
						r.OpenidConnect.Config.Redis.CloudAuthentication.AzureClientID = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AzureClientID)
						r.OpenidConnect.Config.Redis.CloudAuthentication.AzureClientSecret = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AzureClientSecret)
						r.OpenidConnect.Config.Redis.CloudAuthentication.AzureTenantID = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.CloudAuthentication.AzureTenantID)
					...
					r.OpenidConnect.Config.Redis.Database = types.Int64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.Database)
					r.OpenidConnect.Config.Redis.Host = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.Host)
					r.OpenidConnect.Config.Redis.KeepaliveBacklog = types.Int64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.KeepaliveBacklog)
					r.OpenidConnect.Config.Redis.KeepalivePoolSize = types.Int64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.KeepalivePoolSize)
					r.OpenidConnect.Config.Redis.Password = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.Password)
					r.OpenidConnect.Config.Redis.Port = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.Port)
					r.OpenidConnect.Config.Redis.Prefix = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.Prefix)
					...
					if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.SentinelRole != nil {
						r.OpenidConnect.Config.Redis.SentinelRole = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.SentinelRole))
					} else {
						r.OpenidConnect.Config.Redis.SentinelRole = types.StringNull()
					}
					r.OpenidConnect.Config.Redis.SentinelUsername = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.SentinelUsername)
					r.OpenidConnect.Config.Redis.ServerName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.ServerName)
					r.OpenidConnect.Config.Redis.Socket = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.Socket)
					r.OpenidConnect.Config.Redis.Ssl = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.Ssl)
					r.OpenidConnect.Config.Redis.SslVerify = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.SslVerify)
					r.OpenidConnect.Config.Redis.Username = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Redis.Username)
				}
				r.OpenidConnect.Config.RediscoveryLifetime = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RediscoveryLifetime)
				r.OpenidConnect.Config.RefreshTokenParamName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RefreshTokenParamName)
				r.OpenidConnect.Config.RefreshTokenParamType = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RefreshTokenParamType))
				for _, v := range resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RefreshTokenParamType {
				...
				r.OpenidConnect.Config.RefreshTokens = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RefreshTokens)
				r.OpenidConnect.Config.RequireProofKeyForCodeExchange = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RequireProofKeyForCodeExchange)
				r.OpenidConnect.Config.RequirePushedAuthorizationRequests = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RequirePushedAuthorizationRequests)
				r.OpenidConnect.Config.RequireSignedRequestObject = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RequireSignedRequestObject)
				r.OpenidConnect.Config.ResolveDistributedClaims = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ResolveDistributedClaims)
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ResponseMode != nil {
					r.OpenidConnect.Config.ResponseMode = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ResponseMode))
				} else {
					r.OpenidConnect.Config.ResponseMode = types.StringNull()
				}
				r.OpenidConnect.Config.ResponseType = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ResponseType))
				for _, v := range resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ResponseType {
					r.OpenidConnect.Config.ResponseType = append(r.OpenidConnect.Config.ResponseType, types.StringValue(v))
				}
				r.OpenidConnect.Config.Reverify = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Reverify)
				r.OpenidConnect.Config.RevocationEndpoint = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RevocationEndpoint)
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RevocationEndpointAuthMethod != nil {
					r.OpenidConnect.Config.RevocationEndpointAuthMethod = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RevocationEndpointAuthMethod))
				} else {
					r.OpenidConnect.Config.RevocationEndpointAuthMethod = types.StringNull()
				}
				r.OpenidConnect.Config.RevocationTokenParamName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RevocationTokenParamName)
				r.OpenidConnect.Config.RolesClaim = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.RolesClaim))
				...
				r.OpenidConnect.Config.ScopesClaim = make([]types.String, 0, len(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.ScopesClaim))
				...
				r.OpenidConnect.Config.SessionCookieName = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionCookieName)
				r.OpenidConnect.Config.SessionCookiePath = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionCookiePath)
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionCookieSameSite != nil {
					r.OpenidConnect.Config.SessionCookieSameSite = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionCookieSameSite))
				} else {
					r.OpenidConnect.Config.SessionCookieSameSite = types.StringNull()
				}
				r.OpenidConnect.Config.SessionCookieSecure = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionCookieSecure)
				r.OpenidConnect.Config.SessionEnforceSameSubject = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionEnforceSameSubject)
				r.OpenidConnect.Config.SessionHashStorageKey = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionHashStorageKey)
				r.OpenidConnect.Config.SessionHashSubject = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionHashSubject)
				r.OpenidConnect.Config.SessionIdlingTimeout = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionIdlingTimeout)
				r.OpenidConnect.Config.SessionMemcachedHost = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionMemcachedHost)
				r.OpenidConnect.Config.SessionMemcachedPort = types.Int64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionMemcachedPort)
				r.OpenidConnect.Config.SessionMemcachedPrefix = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionMemcachedPrefix)
				r.OpenidConnect.Config.SessionMemcachedSocket = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionMemcachedSocket)
				r.OpenidConnect.Config.SessionMemcachedSsl = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionMemcachedSsl)
				r.OpenidConnect.Config.SessionMemcachedSslVerify = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionMemcachedSslVerify)
				r.OpenidConnect.Config.SessionRemember = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionRemember)
				...
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionStorage != nil {
					r.OpenidConnect.Config.SessionStorage = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionStorage))
				} else {
					r.OpenidConnect.Config.SessionStorage = types.StringNull()
				}
				r.OpenidConnect.Config.SessionStoreMetadata = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.SessionStoreMetadata)
				...
				r.OpenidConnect.Config.Timeout = types.Float64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.Timeout)
				r.OpenidConnect.Config.TLSClientAuthCertID = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TLSClientAuthCertID)
				r.OpenidConnect.Config.TLSClientAuthSslVerify = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TLSClientAuthSslVerify)
				r.OpenidConnect.Config.TokenCacheKeyIncludeScope = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TokenCacheKeyIncludeScope)
				r.OpenidConnect.Config.TokenEndpoint = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TokenEndpoint)
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TokenEndpointAuthMethod != nil {
					r.OpenidConnect.Config.TokenEndpointAuthMethod = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TokenEndpointAuthMethod))
				} else {
					r.OpenidConnect.Config.TokenEndpointAuthMethod = types.StringNull()
				}
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TokenExchange == nil {
					r.OpenidConnect.Config.TokenExchange = nil
				} else {
					r.OpenidConnect.Config.TokenExchange = &tfTypes.TokenExchange{}
					if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TokenExchange.Cache == nil {
						r.OpenidConnect.Config.TokenExchange.Cache = nil
					} else {
						r.OpenidConnect.Config.TokenExchange.Cache = &tfTypes.Cache{}
						r.OpenidConnect.Config.TokenExchange.Cache.Enabled = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TokenExchange.Cache.Enabled)
						r.OpenidConnect.Config.TokenExchange.Cache.TTL = types.Int64PointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TokenExchange.Cache.TTL)
					}
					if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TokenExchange.Request == nil {
					...
					for _, subjectTokenIssuersItem := range resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.TokenExchange.SubjectTokenIssuers {
				...
				r.OpenidConnect.Config.UpstreamIntrospectionHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.UpstreamIntrospectionHeader)
				r.OpenidConnect.Config.UpstreamIntrospectionJwtHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.UpstreamIntrospectionJwtHeader)
				r.OpenidConnect.Config.UpstreamRefreshTokenHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.UpstreamRefreshTokenHeader)
				r.OpenidConnect.Config.UpstreamSessionIDHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.UpstreamSessionIDHeader)
				r.OpenidConnect.Config.UpstreamUserInfoHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.UpstreamUserInfoHeader)
				r.OpenidConnect.Config.UpstreamUserInfoJwtHeader = types.StringPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.UpstreamUserInfoJwtHeader)
				if resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.UserinfoAccept != nil {
					r.OpenidConnect.Config.UserinfoAccept = types.StringValue(string(*resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.UserinfoAccept))
				} else {
				...
				r.OpenidConnect.Config.VerifyNonce = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.VerifyNonce)
				r.OpenidConnect.Config.VerifyParameters = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.VerifyParameters)
				r.OpenidConnect.Config.VerifySignature = types.BoolPointerValue(resp.AIGatewayIdentityProviderOpenIDConnectResponse.Config.VerifySignature)
			}
	...
	if r.OpenidConnect != nil {
		...
		if r.OpenidConnect.Config != nil {
			...
			if r.OpenidConnect.Config.ClusterCacheRedis != nil {
				var cloudAuthentication *shared.AIGatewayIdentityProviderOpenIDConnectCloudAuthentication
				if r.OpenidConnect.Config.ClusterCacheRedis.CloudAuthentication != nil {
					...
					cloudAuthentication = &shared.AIGatewayIdentityProviderOpenIDConnectCloudAuthentication{
			...
			var principals1 *shared.AIGatewayIdentityProviderOpenIDConnectPrincipals
			...
			if r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader != nil {
				...
				if !r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.CertificateHeaderFormat.IsUnknown() && !r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.CertificateHeaderFormat.IsNull() {
					*certificateHeaderFormat = shared.CertificateHeaderFormat(r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.CertificateHeaderFormat.ValueString())
				} else {
				...
				if !r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.RevocationCheckMode.IsUnknown() && !r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.RevocationCheckMode.IsNull() {
					*revocationCheckMode = shared.RevocationCheckMode(r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.RevocationCheckMode.ValueString())
				} else {
				...
				if !r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.SslVerify.IsUnknown() && !r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.SslVerify.IsNull() {
					*sslVerify1 = r.OpenidConnect.Config.ProofOfPossessionMtlsFromHeader.SslVerify.ValueBool()
				} else {
					sslVerify1 = nil
				}
			...
			if r.OpenidConnect.Config.Redis != nil {
				var cloudAuthentication1 *shared.AIGatewayIdentityProviderOpenIDConnectConfigCloudAuthentication
				if r.OpenidConnect.Config.Redis.CloudAuthentication != nil {
					authProvider1 := new(shared.AIGatewayIdentityProviderOpenIDConnectAuthProvider)
					if !r.OpenidConnect.Config.Redis.CloudAuthentication.AuthProvider.IsUnknown() && !r.OpenidConnect.Config.Redis.CloudAuthentication.AuthProvider.IsNull() {
						*authProvider1 = shared.AIGatewayIdentityProviderOpenIDConnectAuthProvider(r.OpenidConnect.Config.Redis.CloudAuthentication.AuthProvider.ValueString())
					} else {
						authProvider1 = nil
					}
					...
					cloudAuthentication1 = &shared.AIGatewayIdentityProviderOpenIDConnectConfigCloudAuthentication{
				...
				sentinelRole1 := new(shared.AIGatewayIdentityProviderOpenIDConnectSentinelRole)
				if !r.OpenidConnect.Config.Redis.SentinelRole.IsUnknown() && !r.OpenidConnect.Config.Redis.SentinelRole.IsNull() {
					*sentinelRole1 = shared.AIGatewayIdentityProviderOpenIDConnectSentinelRole(r.OpenidConnect.Config.Redis.SentinelRole.ValueString())
				} else {
					sentinelRole1 = nil
				}
				...
				if !r.OpenidConnect.Config.Redis.SslVerify.IsUnknown() && !r.OpenidConnect.Config.Redis.SslVerify.IsNull() {
					*sslVerify2 = r.OpenidConnect.Config.Redis.SslVerify.ValueBool()
				} else {
					sslVerify2 = nil
				}
			...
			if !r.OpenidConnect.Config.SslVerify.IsUnknown() && !r.OpenidConnect.Config.SslVerify.IsNull() {
				*sslVerify3 = r.OpenidConnect.Config.SslVerify.ValueBool()
			} else {
				sslVerify3 = nil
			}
			timeout := new(float64)
			...
			tokenEndpointAuthMethod := new(shared.AIGatewayIdentityProviderOpenIDConnectTokenEndpointAuthMethod)
			if !r.OpenidConnect.Config.TokenEndpointAuthMethod.IsUnknown() && !r.OpenidConnect.Config.TokenEndpointAuthMethod.IsNull() {
				*tokenEndpointAuthMethod = shared.AIGatewayIdentityProviderOpenIDConnectTokenEndpointAuthMethod(r.OpenidConnect.Config.TokenEndpointAuthMethod.ValueString())
			} else {
