...
func (r *MeshTimeoutListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	request, requestDiags := data.ToOperationsGetMeshTimeoutListRequest(ctx)
	...
	resp.Diagnostics.Append(data.RefreshFromSharedMeshTimeoutList(ctx, res.MeshTimeoutList)...)
