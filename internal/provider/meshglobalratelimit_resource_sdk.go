		...
		if fromItem.Default != nil {
			...
			if fromItem.Default.HTTP.OnRateLimit != nil {
				...
				if fromItem.Default.HTTP.OnRateLimit.Headers != nil {
					var add []shared.MeshGlobalRateLimitItemAdd = []shared.MeshGlobalRateLimitItemAdd{}
					...
					var set []shared.MeshGlobalRateLimitItemSet = []shared.MeshGlobalRateLimitItemSet{}
		...
		if toItem.Default != nil {
			...
			if toItem.Default.HTTP.OnRateLimit != nil {
				...
				if toItem.Default.HTTP.OnRateLimit.Headers != nil {
					var add1 []shared.MeshGlobalRateLimitItemSpecAdd = []shared.MeshGlobalRateLimitItemSpecAdd{}
					...
					var set1 []shared.MeshGlobalRateLimitItemSpecSet = []shared.MeshGlobalRateLimitItemSpecSet{}
			...
			if fromItem.Default == nil {
				...
				if fromItem.Default.HTTP.OnRateLimit == nil {
					...
					if fromItem.Default.HTTP.OnRateLimit.Headers == nil {
						...
						from1.Default.HTTP.OnRateLimit.Headers = &tfTypes.MeshGlobalRateLimitItemHeaders{}
						from1.Default.HTTP.OnRateLimit.Headers.Add = []tfTypes.MeshGlobalRateLimitItemAdd{}
						...
						from1.Default.HTTP.OnRateLimit.Headers.Set = []tfTypes.MeshGlobalRateLimitItemAdd{}
			...
			if toItem.Default == nil {
				...
				if toItem.Default.HTTP.OnRateLimit == nil {
					...
					if toItem.Default.HTTP.OnRateLimit.Headers == nil {
						...
						to1.Default.HTTP.OnRateLimit.Headers = &tfTypes.MeshGlobalRateLimitItemHeaders{}
						to1.Default.HTTP.OnRateLimit.Headers.Add = []tfTypes.MeshGlobalRateLimitItemAdd{}
						...
						to1.Default.HTTP.OnRateLimit.Headers.Set = []tfTypes.MeshGlobalRateLimitItemAdd{}
