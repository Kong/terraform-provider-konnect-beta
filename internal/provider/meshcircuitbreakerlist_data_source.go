...
func (r *MeshCircuitBreakerListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	request, requestDiags := data.ToOperationsGetMeshCircuitBreakerListRequest(ctx)
	...
	resp.Diagnostics.Append(data.RefreshFromSharedMeshCircuitBreakerList(ctx, res.MeshCircuitBreakerList)...)
