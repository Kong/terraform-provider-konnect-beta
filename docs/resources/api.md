...
- `content_payload` (Attributes) The raw content of API specification, in json or yaml format (OpenAPI or AsyncAPI). Requires replacement if changed. (see [below for nested schema](#nestedatt--spec--content_payload))
- `provider_payload` (Attributes) Represent spec provider information used for fetching the API spec. For raw, provide the raw content in the `content` property instead of using this provider. Requires replacement if changed. (see [below for nested schema](#nestedatt--spec--provider_payload))

<a id="nestedatt--spec--content_payload"></a>
### Nested Schema for `spec.content_payload`
...
<a id="nestedatt--spec--provider_payload"></a>
### Nested Schema for `spec.provider_payload`

Required:

- `provider` (Attributes) Requires replacement if changed. (see [below for nested schema](#nestedatt--spec--provider_payload--provider))

<a id="nestedatt--spec--provider_payload--provider"></a>
### Nested Schema for `spec.provider_payload.provider`
...
Requires replacement if changed. (see [below for nested schema](#nestedatt--spec--provider_payload--provider--integration_provider))
...
Consult integration documentation to learn more about available API spec providers.
Requires replacement if changed. (see [below for nested schema](#nestedatt--spec--provider_payload--provider--resource_bound_integration_provider))
- `url_provider` (Attributes) Requires replacement if changed. (see [below for nested schema](#nestedatt--spec--provider_payload--provider--url_provider))

<a id="nestedatt--spec--provider_payload--provider--integration_provider"></a>
### Nested Schema for `spec.provider_payload.provider.integration_provider`
...
<a id="nestedatt--spec--provider_payload--provider--resource_bound_integration_provider"></a>
### Nested Schema for `spec.provider_payload.provider.resource_bound_integration_provider`

Required:

- `config` (Attributes) Requires replacement if changed. (see [below for nested schema](#nestedatt--spec--provider_payload--provider--resource_bound_integration_provider--config))
...
<a id="nestedatt--spec--provider_payload--provider--resource_bound_integration_provider--config"></a>
### Nested Schema for `spec.provider_payload.provider.resource_bound_integration_provider.config`
...
<a id="nestedatt--spec--provider_payload--provider--url_provider"></a>
### Nested Schema for `spec.provider_payload.provider.url_provider`

Required:

- `config` (Attributes) Requires replacement if changed. (see [below for nested schema](#nestedatt--spec--provider_payload--provider--url_provider--config))
- `type` (String) must be "url"; Requires replacement if changed.

<a id="nestedatt--spec--provider_payload--provider--url_provider--config"></a>
### Nested Schema for `spec.provider_payload.provider.url_provider.config`
