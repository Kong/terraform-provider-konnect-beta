...
page_title: "konnect_event_gateway_consume_policy_decrypt_fields Resource - terraform-provider-konnect-beta"
subcategory: ""
description: |-
...
- `paths` (Attributes) Selects which fields of the parsed record to decrypt. A maximum of 50 path entries are allowed. (see [below for nested schema](#nestedatt--config--decrypt_fields--paths))
...
- `array_of_event_gateway_parsed_record_field_paths_array` (Attributes List) (see [below for nested schema](#nestedatt--config--decrypt_fields--paths--array_of_event_gateway_parsed_record_field_paths_array))
- `str` (String)

<a id="nestedatt--config--decrypt_fields--paths--array_of_event_gateway_parsed_record_field_paths_array"></a>
### Nested Schema for `config.decrypt_fields.paths.array_of_event_gateway_parsed_record_field_paths_array`
