...
page_title: "konnect_event_gateway_virtual_cluster_consume_policy_skip_record Resource - terraform-provider-konnect-beta"
subcategory: ""
description: |-
  EventGatewayVirtualClusterConsumePolicySkipRecord Resource
---

# konnect_event_gateway_virtual_cluster_consume_policy_skip_record (Resource)
...
```shell
terraform import konnect_event_gateway_virtual_cluster_consume_policy_skip_record.my_konnect_event_gateway_virtual_cluster_consume_policy_skip_record '{"gateway_id": "9524ec7d-36d9-465d-a8c5-83a3c9390458", "id": "9524ec7d-36d9-465d-a8c5-83a3c9390458", "virtual_cluster_id": ""}'
```
