...
page_title: "konnect-beta_portal_customization Resource - terraform-provider-konnect-beta"
subcategory: ""
description: |-
  PortalCustomization Resource
---

# konnect-beta_portal_customization (Resource)
...
```shell
terraform import konnect-beta_portal_customization.my_konnect-beta_portal_customization "f32d905a-ed33-46a3-a093-d8f536af9a8a"
```
