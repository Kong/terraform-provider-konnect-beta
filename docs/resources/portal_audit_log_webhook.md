...
page_title: "konnect_portal_audit_log_webhook Resource - terraform-provider-konnect-beta"
subcategory: ""
description: |-
...
- `include_principal_name` (Boolean) Whether to include the principal name in the audit log entries sent to the webhook. Default: false
