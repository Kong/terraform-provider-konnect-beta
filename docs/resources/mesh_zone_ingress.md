...
page_title: "konnect_mesh_zone_ingress Resource - terraform-provider-konnect-beta"
subcategory: ""
description: |-
  MeshZoneIngress Resource
---

# konnect_mesh_zone_ingress (Resource)
...
```terraform
import {
  to = konnect_mesh_zone_ingress.my_konnect_mesh_zone_ingress
  id = jsonencode({
    cp_id = "bf138ba2-c9b1-4229-b268-04d9d8a6410b"
    name = "..."
  })
