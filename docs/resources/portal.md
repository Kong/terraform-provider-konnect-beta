...
- `default_api_visibility` (String) The default visibility of APIs in the portal. possible known values include one of ["public", "private"]
...
- `default_page_visibility` (String) The default visibility of pages in the portal. possible known values include one of ["public", "private"]
