...
page_title: "konnect-beta_portal Resource - terraform-provider-konnect-beta"
subcategory: ""
description: |-
  Portal Resource
---

# konnect-beta_portal (Resource)
...
```terraform
import {
  to = konnect-beta_portal.my_konnect-beta_portal
...
```shell
terraform import konnect-beta_portal.my_konnect-beta_portal "5f9fd312-a987-4628-b4c5-bb4f4fddd5f7"
```
