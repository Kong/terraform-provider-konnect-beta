...
page_title: "konnect_event_gateway_virtual_cluster_produce_policy_modify_headers Resource - terraform-provider-konnect-beta"
subcategory: ""
description: |-
  EventGatewayVirtualClusterProducePolicyModifyHeaders Resource
---

# konnect_event_gateway_virtual_cluster_produce_policy_modify_headers (Resource)
...
```shell
terraform import konnect_event_gateway_virtual_cluster_produce_policy_modify_headers.my_konnect_event_gateway_virtual_cluster_produce_policy_modify_headers '{"gateway_id": "9524ec7d-36d9-465d-a8c5-83a3c9390458", "id": "9524ec7d-36d9-465d-a8c5-83a3c9390458", "virtual_cluster_id": ""}'
```
