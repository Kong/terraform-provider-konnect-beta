...
page_title: "konnect-beta_portal_auth Resource - terraform-provider-konnect-beta"
subcategory: ""
description: |-
  PortalAuth Resource
---

# konnect-beta_portal_auth (Resource)
...
```shell
terraform import konnect-beta_portal_auth.my_konnect-beta_portal_auth "f32d905a-ed33-46a3-a093-d8f536af9a8a"
```
