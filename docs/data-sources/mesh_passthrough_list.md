...
page_title: "konnect-beta_mesh_passthrough_list Data Source - terraform-provider-konnect-beta"
subcategory: ""
description: |-
  MeshPassthroughList DataSource
---

# konnect-beta_mesh_passthrough_list (Data Source)
...
- `spec` (Attributes) Spec is the specification of the Kuma MeshPassthrough resource. (see [below for nested schema](#nestedatt--items--spec))
...
- `default` (Attributes) MeshPassthrough configuration. (see [below for nested schema](#nestedatt--items--spec--default))
...
- `append_match` (Attributes List) AppendMatch is a list of destinations that should be allowed through the sidecar. (see [below for nested schema](#nestedatt--items--spec--default--append_match))
...
<a id="nestedatt--items--spec--default--append_match"></a>
### Nested Schema for `items.spec.default.append_match`
