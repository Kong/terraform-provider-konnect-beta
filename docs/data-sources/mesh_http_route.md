...
page_title: "konnect-beta_mesh_http_route Data Source - terraform-provider-konnect-beta"
subcategory: ""
description: |-
  MeshHTTPRoute DataSource
---

# konnect-beta_mesh_http_route (Data Source)
...
request destinations. (see [below for nested schema](#nestedatt--spec--to--target_ref))
...
to. (see [below for nested schema](#nestedatt--spec--to--rules--matches))
